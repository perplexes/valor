...
Starfield = (function() {
  function Starfield() {
    this.tilesize = 1024;
    this.density = 31;
    this.levels = [this.generateTile(2, [184, 184, 184]), this.generateTile(3, [96, 96, 96])];
  }
  ...
  Starfield.prototype.draw = function(viewport, ship, ctx) {
    return [this.drawLevel(viewport, ship, ctx, this.levels[0]), this.drawLevel(viewport, ship, ctx, this.levels[1])];
  };
